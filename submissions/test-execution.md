...
| TC-14 | Borrow book | Borrow button is NOT displayed (or disabled) because book is already borrowed | Borrow button is NOT displayed for borrowed book | ✅ **PASS** | - | - |
...
| TC-21 | Return book | Return successful + warning "Book return is overdue" | Return successful, NO warning | ❌ **FAIL** | - | BUG-004 |
| TC-22 | Overdue check (1st time) | Detect and mark 2 overdue records | Detect and mark 2 overdue records | ✅ **PASS** | - | - |
| TC-23 | Overdue check (2nd time) | Still detect and mark 2 overdue records | Report 0 overdue records | ❌ **FAIL** | - | BUG-005 |
| TC-24 | Add member | Add successful (valid email) | Show error "Invalid email" | ❌ **FAIL** | - | BUG-006 |
| TC-25 | Add member | Show error "Invalid email" | Add successful | ❌ **FAIL** | - | BUG-006 |
| TC-26 | Borrow record lookup (Librarian) | Display 5 records: BR001-BR005 | Display 5 records | ✅ **PASS** | - | - |
| TC-27 | Borrow record lookup (Member) | Display only BR001, BR004 (own records) | When searching MEM003, still displays MEM003's records (BR002, BR005) | ❌ **FAIL** | - | BUG-007 |
